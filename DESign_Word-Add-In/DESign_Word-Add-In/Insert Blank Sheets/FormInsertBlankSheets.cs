...
namespace DESign_WordAddIn.Insert_Blank_Sheets
{
    public partial class FormInsertBlankSheets : Form
    {
        ...
        {
            addDetail(Properties.Resources.blankBirdCage);

        }

        private void btnInsertBlankTPlate_Click(object sender, EventArgs e)
        {
            addDetail(Properties.Resources.blankTPlate);
        }
        ...
        private void addDetail(Bitmap detail)
        {
            ...
            tblDetailHeader.Cell(1, 6).Range.Text = "T-Plate Detail";
