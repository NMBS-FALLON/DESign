...
namespace DESign_Sales_Excel_Add_In_2.Tools
{
  ...
  {
    private Button btnAddSprinklerLoad;
    private ComboBox cbFSBraceAngle;
    ...
    private TextBox tbLatBraceLoad;
    private TextBox tbLongBraceLoad;
    private TextBox tbMaxJoistLength;
    private TextBox tbMinBraceSpace;
    private TextBox tbPipeWeight;
