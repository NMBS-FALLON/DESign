...
namespace DESign_WordAddIn
{
    class StringManipulation
    {
        ...
        //9.84375 = 9-10 1/8
        {
            ...
            double fraction = (inches - inchDouble) * 16;
            //1 (for 1/8)
            ...
            if (fractionInt == 2) { fractionString = "1"; divisor = "8"; }
            if (fractionInt == 4) { fractionString = "1"; divisor = "4"; }
            if (fractionInt == 6) { fractionString = "3"; divisor = "8"; }
            if (fractionInt == 8) { fractionString = "1"; divisor = "2"; }
            if (fractionInt == 10) { fractionString = "5"; divisor = "8"; }
            if (fractionInt == 12) { fractionString = "3"; divisor = "4"; }
            if (fractionInt == 14) { fractionString = "7"; divisor = "8"; }
  ...
  */
        ...
        public string noZeroFootHyphen (string hyphenLength)
        {
            ...
            if (hyphenLengthArray[0] == "0")
            {
                noZeroFootHyphen = hyphenLengthArray[1];
            }
