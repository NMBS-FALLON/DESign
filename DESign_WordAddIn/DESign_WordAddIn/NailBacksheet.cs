...
namespace DESign_WordAddIn
{
    public partial class FormNailBacksheet : Form
    {
        ...
        private void btnCreateTable_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxNailPlacement.Text == "Staggered") { NailPlacement = Properties.Resources.NonStaggered; }
            else if (comboBoxNailPlacement.Text == "Non-Staggered") { NailPlacement = Properties.Resources.NonStaggered; }
            else { }
